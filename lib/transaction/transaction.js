 ...
 * and a slightly fancier format recognized by potcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a potcore Address object. The
 * same is true for `script`, which can be a string or a potcore Script.
 *
