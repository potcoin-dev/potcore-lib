 ...
 * and a slightly fancier format recognized by viacore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a viacore Address object. The
 * same is true for `script`, which can be a string or a viacore Script.
 *
